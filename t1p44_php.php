...
<body>
   <?php
      ...
      mysqli_query($conexion, "insert into alumnos(nombre, email, codigocurso, fechanac)
         values ('$_REQUEST[nombre]', '$_REQUEST[email]', $_REQUEST[codigocurso], '$fechanac')") or die("Problemas en el insert:".mysqli_error($conexion));
